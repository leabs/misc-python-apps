...
- **Export Fire Departments** - Downloads the public NERIS fire department layer and creates a Meilisearch-ready `departments-meilisearch.ndjson` file with one department per line.
...
- **Export Fire Departments** - I use this to turn the current NERIS fire department data into a validated NDJSON file that can be imported into Meilisearch for department search.
